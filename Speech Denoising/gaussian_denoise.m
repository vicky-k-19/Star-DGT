...
[x_original,fs]=audioread('8842-304647-0007.flac');
...
x_noisy = x_original+sigma(i)*randn(size(x_original));
y = x_noisy;
...
xlabel('standard deviation of Gaussian noise'); ylabel('MSE$$(x,\hat{x})$$','interpreter','latex');
